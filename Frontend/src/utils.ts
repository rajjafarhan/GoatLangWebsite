export const links = [
  ...
  },
  {
    id: "9",
    title: "Comments",
    path: "/handbook/handbook-content/comments",
  },
  {
    id: "10",
    title: "Classes",
...
export const hanbookContent = [
    ...
    code: [
      {
        ...
        codeString: "age = 3",
        explanation:
          "The 'Number' data type represents numeric values. Here, 'age' is assigned the value 3.",
      },
      {
        head: "String",
        codeString: "name = 'GoatLang'",
        explanation:
          "The 'String' data type represents textual data. Here, 'name' is assigned the string 'GoatLang'.",
      },
      {
        head: "Boolean",
        codeString: "isCaprine = true",
        explanation:
          "The 'Boolean' data type represents true or false values. Here, 'isCaprine' is assigned the value 'true'.",
      },
      {
        head: "Array",
        codeString: "numbers = [1, 2, 3, 4, 5]",
        explanation:
          "The 'Array' data type represents an ordered list of values. Here, 'numbers' is an array containing the numbers 1 through 5.",
      },
      {
        head: "Object",
        codeString: "person = { name: 'Bob', age: 25 }",
        explanation:
          "The 'Object' data type represents a collection of key-value pairs. Here, 'person' is an object with 'name' and 'age' properties.",
      },
      {
        head: "Null",
        codeString: "nullValue = null",
        explanation:
          "The 'null' data type represents the absence of a value. Here, 'nullValue' is assigned the value 'null'.",
      },
      {
        head: "Undefined",
        codeString: "undefinedValue = undefined",
        explanation:
          "The 'undefined' data type represents an uninitialized or undefined value. Here, 'undefinedValue' is assigned the value 'undefined'.",
      },
      {
        head: "Function",
        codeString: "fun greet() {\n    display('Baa, hello!')\n}",
        explanation:
          "The 'Function' data type represents a callable block of code. Here, 'greet' is a function that displays a greeting message.",
      },
    ],
  },
  {
    ...
    path: "variables",
    content: {
      desc: "In Goatlang, variables serve as containers for storing and manipulating data. Let's unravel the basics of working with variables in this caprine-inspired language.",
    ...
    code: [
      {
        ...
        codeString: "a = 1",
        explanation:
          "Here, the variable a is limited to the local scope, accessible within its defined context.",
      },
      {
        head: "Global Scope",
        codeString: "global const a = 1",
        explanation:
          "For global scope, use the global keyword before declaring the variable.By prefixing with global, you extend the variable's scope to the entire program, making it accessible from anywhere",
      },
      {
        head: "Constants",
  ...
  },
  {
    ...
    path: "array",
    content: {
      desc: "Arrays are used to store multiple values in a single variable, instead of declaring separate variables for each value.",
      h1: "GoatLang Array",
    },
    code: [
      {
        ...
        explanation:
          "To declare an array, specify the name of the array followed by using array literal to insert values in a comma-separated list, inside curly braces.",
      },
      {
        head: "Access the Elements of an Array",
        codeString: "numbers = [1, 2, 3, 4, 5]; \nnumbers -> 0;",
        explanation:
          "This statement accesses the value of the first element in numbers. You can access elements by referring to the index number. Remember that array indexes in Goat Lang start with 0, with numbers->0 representing the first element.",
      },
      {
        codeString:
          "numbers = [1, 2, 3, 4, 5]; \nnumbers -> (numbers.length-1);",
        explanation:
          "This statement accesses the value of the element one less than the length of array.",
      },
      {
        head: "Modifying an Array",
        codeString: "numbers = [1, 2, 3, 4, 5]; \nnumbers -> 0 = 5;",
        explanation:
          "This statement accesses the value of the first element in numbers and modifies its value from initial value 1 to final value 5. The value at the first index is updated.",
      },
    ],
  },
  {
    ...
    code: [
      {
        ...
        explanation:
          "Here, we create an object 'person' with properties like 'name', 'age', and 'city'. Each property is associated with a value.",
      },
      {
        head: "Accessing Properties",
        codeString: "personName = person.name",
        explanation:
          "To access the 'name' property of the 'person' object, we use dot notation. 'personName' will be assigned the value 'Bob'.",
      },
      {
        head: "Adding New Properties",
        codeString: "person.job = 'Goat Developer'",
        explanation:
          "You can dynamically add new properties to an existing object. Here, we add a 'job' property to the 'person' object.",
      },
      {
        head: "Nested Objects",
        codeString:
          "address = { city: 'Caprineville', zip: '12345' }\nperson.address = address",
        explanation:
          "Objects can also contain other objects. Here, we create an 'address' object and nest it within the 'person' object.",
      },
      {
        head: "Object Methods",
        codeString: "person.sayHello = function() { return 'Baa, hello!' }",
        explanation:
          "In GoatLang, objects can have methods (functions as properties). Here, 'sayHello' is a method of the 'person' object.",
      },
    ],
  },
  {
    ...
    path: "forloop",
    content: {
      desc: "Loops can execute a block of code as long as a specified condition is reached.\nLoops are handy because they save time, reduce errors, and they make code more readable.",
    ...
    code: [
      {
        ...
        codeString: "i = 0",
        explanation:
          "Before entering the 'while' loop, you often need to initialize a variable. Here, 'i' is initialized to 0.",
      },
      {
        head: "While Loop Syntax",
        codeString: "until (i < 10) {\n    i = i + 1\n    display(i)\n}",
        explanation:
          "The 'until' keyword is used to start a 'while' loop, followed by the condition in parentheses. The code inside the curly braces will be executed as long as the condition is true.",
      },
      {
        head: "Loop Condition",
        codeString: "i < 10",
        explanation:
          "The condition inside the parentheses determines when the 'while' loop should continue executing. In this case, the loop continues as long as 'i' is less than 10.",
      },
      {
        head: "Updating the Variable",
        codeString: "i = i + 1",
        explanation:
          "Within the 'while' loop, you often need to update the variable that is part of the loop condition. Here, 'i' is incremented by 1 in each iteration.",
      },
      {
        head: "Displaying Output",
        codeString: "display(i)",
        explanation:
          "Here, the 'display' function is used to output the current value of 'i'. You can replace this with any code relevant to your use case.",
      },
      {
...

  {
    ...
    code: [
      ...
      },
      {
        ...
        explanation:
          "Nested 'if' statements in Goatlang provide a way to evaluate multiple conditions in a hierarchical manner. Each 'if' statement inside another is known as a nested 'if,' and it allows for intricate decision-making",
      },
    ],
  },
  {
    ...
    code: [
      {
        ...
        codeString: "name = 'GoatLang'\ndisplay(name)",
        explanation:
          "The 'display' statement is used to output the value of a variable. Here, the value of the 'name' variable will be displayed.",
      },
      {
        head: "Concatenation",
        codeString: "age = 3\ndisplay('The goat is ' + age + ' years old')",
        explanation:
          "You can concatenate strings and variables within the 'display' statement. This is useful for creating dynamic output.",
      },
      {
        head: "Multiple Parameters",
        codeString: "height = 1.2\ndisplay('Height:', height, 'm')",
        explanation:
          "The 'display' statement can take multiple parameters, separating them with commas. Each parameter will be displayed in order.",
      },
      {
        head: "String Literals",
        codeString: "display('Hello, world!')",
        explanation:
          "You can directly display string literals using the 'display' statement. This is useful for fixed text or messages.",
      },
      {
        head: "Expression Evaluation",
        codeString: "result = 5 * 7\ndisplay('The result is:', result)",
        explanation:
          "Expressions can be evaluated within the 'display' statement. Here, the result of the expression '5 * 7' will be displayed.",
      },
      {
        head: "Formatting Output",
        codeString: "pi = 3.14159\ndisplay('Value of pi:', pi.toFixed(2))",
        explanation:
          "You can format the output of numerical values using methods like 'toFixed'. Here, the value of 'pi' is displayed with two decimal places.",
      },
      {
        head: "Special Characters",
        codeString: "display('Newline character: \\nTab character: \\t')",
        explanation:
          "Special characters can be included in the 'display' statement. Here, the newline character '\\n' and tab character '\\t' are used.",
      },
    ],
  },
    ...
    code: [
      {
        ...
        explanation:
          "Here, we define a function 'greet' that takes a parameter 'name' and returns a greeting message. The 'fun' keyword is used to declare a function.",
      },
      {
        head: "Function Invocation",
        codeString: "message = greet('Alice')",
        explanation:
          "To invoke a function, use its name followed by parentheses and provide any required arguments. The 'message' variable will contain the result of the 'greet' function.",
      },
      {
        head: "Parameters and Arguments",
        codeString: "fun add(a, b) {\n    return a + b\n}\nresult = add(3, 5)",
        explanation:
          "Functions can take parameters (inputs). In this example, the 'add' function takes two parameters 'a' and 'b', and returns their sum when invoked with arguments 3 and 5.",
      },
      {
        head: "Default Parameters",
        codeString:
          "fun exponentiate(base, power=2) {\n    return base ** power\n}\nresult = exponentiate(3)",
        explanation:
          "You can provide default values for parameters. If the 'power' parameter is not provided when invoking 'exponentiate', it defaults to 2.",
      },
      {
        ...
        codeString:
          "fun multiply(a, b) {\n    let result = a * b\n    return result\n}",
        explanation:
          "The 'return' statement is used to specify the value that the function should return. Here, 'multiply' returns the product of 'a' and 'b'.",
      },
      {
        head: "Function Scope",
        codeString:
          "let globalVar = 10\nfun printGlobalVar() {\n    print(globalVar)\n}\nprintGlobalVar()",
        explanation:
          "Functions have their own scope. Variables defined inside a function are local to that function, unless explicitly declared as global.",
      },
    ],
  },
  {
    ...
    path: "comments",
    content: {
      desc: "Comments in programming languages are non-executable text that you include in your code to provide information, explanations, or annotations. They are intended for human readers, such as other programmers or yourself, and have no impact on the program's functionality when it is executed.",
      h1: "Comments in GoatLang",
    },
    code: [
      {
        head: "Your First Comment",
        codeString:
          "##Below is the while loop that prints number from 0 to 9"+"\n\ni = 0;\nuntil (i < 10) {\n    i = i + 1\n    display(i)\n}\n##Program Ended",
        explanation:
          "In GoatLang, comments are single-lined and start with a double hash '##'. Therefore, whenever a new line is encountered, the comments are automatically terminated.\nIn the above example first and last lines are comments as they are starting from '##'",
      },
    ],
  },
  {
